...
_BASELINE_KNOWN_OPEN: frozenset[tuple[str, int, str]] = frozenset({
    ...
    ("generate_report.py", 1325, "shortRatio"),
    ("generate_report.py", 1326, "shortPercentOfFloat"),
    ("generate_report.py", 1344, "floatShares"),
    ("generate_report.py", 2698, "float_shares"),
    ("generate_report.py", 2712, "52w_high"),
    ("generate_report.py", 2713, "52w_low"),
    ("generate_report.py", 2718, "market_cap"),
    ("generate_report.py", 2911, "float_shares"),
    ("generate_report.py", 3063, "float_shares"),
    ("generate_report.py", 3088, "float_shares"),
    ("generate_report.py", 3972, "rsi14"),
    ("generate_report.py", 4004, "score"),
    ("generate_report.py", 4296, "short_float"),
    ("generate_report.py", 4318, "rel_volume"),
    ("generate_report.py", 4336, "short_float"),
    ("generate_report.py", 4337, "short_ratio"),
    ("generate_report.py", 4338, "rel_volume"),
    ("generate_report.py", 4470, "float_shares"),
    ("generate_report.py", 4471, "price"),
    ("generate_report.py", 4472, "market_cap"),
    ("generate_report.py", 4553, "float_shares"),
    ("generate_report.py", 4872, "float_shares"),
    ("generate_report.py", 4873, "float_shares"),
    ("generate_report.py", 4874, "float_shares"),
    ("generate_report.py", 4875, "float_shares"),
    ("generate_report.py", 5478, "score"),
    ("generate_report.py", 5935, "short_float"),
    ("generate_report.py", 5936, "short_ratio"),
    ("generate_report.py", 5937, "rel_volume"),
    ("generate_report.py", 5939, "change"),
    ("generate_report.py", 6205, "float_shares"),
    ("generate_report.py", 6310, "52w_high"),
    ("generate_report.py", 6310, "52w_low"),
    ("generate_report.py", 6407, "price"),
    ("generate_report.py", 6408, "short_float"),
    ("generate_report.py", 6409, "short_ratio"),
    ("generate_report.py", 6410, "rel_volume"),
    ("generate_report.py", 6411, "change"),
    ("generate_report.py", 6746, "float_shares"),
    ("generate_report.py", 6754, "52w_high"),
    ("generate_report.py", 6755, "52w_low"),
    ("generate_report.py", 7437, "float_shares"),
    ("generate_report.py", 16201, "entry_price"),
    ("generate_report.py", 16210, "price"),
    ("generate_report.py", 16234, "setup_today"),
    ("generate_report.py", 16991, "score"),
    ("generate_report.py", 17488, "score"),
    ("generate_report.py", 18042, "score"),
    ("generate_report.py", 18085, "score"),
    ("generate_report.py", 18234, "score"),

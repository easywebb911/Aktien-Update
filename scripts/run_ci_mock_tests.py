...
ALLOWLIST = [
    "backfill_entry_past_return_5d", "backfill_max_gain", "backtest_data_integrity", "bootstrap_shell_phase0", "bootstrap_shell_phase1", "borrow_iborrowdesk", "card_cockpit_stage1", "card_cockpit_stage2",
    ...
    "finnhub_skip_logging", "finra_publication_date", "gitattributes_union_merge", "good_friday",
    ...
    "attention_wiki", "purge_attention_wiki", "reload_toast", "run_phase_resolution", "runphase_pill", "rvol_normalization", "s10_data_integrity",

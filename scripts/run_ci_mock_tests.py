...
ALLOWLIST = [
    "backfill_entry_past_return_5d", "backfill_max_gain", "backtest_data_integrity", "backtest_history_writepath", "bootstrap_shell_phase0", "bootstrap_shell_phase1", "borrow_iborrowdesk", "card_cockpit_stage1", "card_cockpit_stage2",
    "borrow_dormant",
